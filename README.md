<img width="200" height="150" alt="workflow" src="https://github.com/user-attachments/assets/db590fc5-73a7-4630-9f8c-bd2ff37fcf41" /># ASSIS — RampGuard: AI-Integrated Airport Safety and Security Intelligence System — Phase 1 (PPE Compliance Detection)

![U<svg viewBox="0 0 1040 780" xmlns="http://www.w3.org/2000/svg" font-family="Inter, -apple-system, Helvetica, sans-serif">
  <defs>
    <marker id="arrow" markerWidth="9" markerHeight="9" refX="7" refY="2.5" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,5 L7,2.5 z" fill="#64748B"/>
    </marker>
    <marker id="arrowAmber" markerWidth="9" markerHeight="9" refX="7" refY="2.5" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,5 L7,2.5 z" fill="#B5740A"/>
    </marker>
    <filter id="cardShadow" x="-20%" y="-20%" width="140%" height="140%">
      <feDropShadow dx="0" dy="1.5" stdDeviation="3" flood-color="#0F172A" flood-opacity="0.08"/>
    </filter>
  </defs>

  <rect width="1040" height="780" fill="#FAFBFC"/>

  <!-- Header -->
  <text x="60" y="46" font-size="21" font-weight="800" fill="#0F172A" letter-spacing="-0.3">ASSIS — RampGuard</text>
  <text x="60" y="68" font-size="12.5" fill="#64748B">PPE Compliance Detection Pipeline · Phase 1</text>

  <rect x="792" y="30" width="188" height="24" rx="12" fill="#EAF0FA"/>
  <text x="886" y="46" text-anchor="middle" font-size="10.5" font-weight="600" fill="#2F5FA6" letter-spacing="0.3">DUAL-MODEL · METAR-CONDITIONAL</text>

  <line x1="60" y1="84" x2="980" y2="84" stroke="#E4E7EC" stroke-width="1"/>

  <!-- Stage label helper style: small eyebrow above each row -->
  <text x="60" y="118" font-size="10.5" font-weight="700" fill="#94A3B8" letter-spacing="1">01   INPUT</text>

  <!-- Input -->
  <rect x="330" y="128" width="270" height="58" rx="10" fill="#EAF0FA" stroke="#B9CDEA" stroke-width="1.2" filter="url(#cardShadow)"/>
  <text x="465" y="152" text-anchor="middle" font-size="13" font-weight="700" fill="#1E3A5F">Input Image / Video Frame</text>
  <text x="465" y="170" text-anchor="middle" font-size="11" fill="#4A6E93">Airport ramp CCTV</text>

  <!-- METAR branch -->
  <rect x="700" y="128" width="240" height="58" rx="10" fill="#FEF6E7" stroke="#EBCB8F" stroke-width="1.2" stroke-dasharray="5,3" filter="url(#cardShadow)"/>
  <text x="820" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#7A4A05">Live METAR</text>
  <text x="820" y="168" text-anchor="middle" font-size="11" fill="#96690F">NOAA AWC · by airport ICAO</text>

  <line x1="410" y1="186" x2="410" y2="216" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>
  <line x1="530" y1="186" x2="530" y2="216" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>

  <text x="60" y="204" font-size="10.5" font-weight="700" fill="#94A3B8" letter-spacing="1">02   DETECTION</text>

  <!-- Base model -->
  <rect x="180" y="216" width="300" height="64" rx="10" fill="#FFFFFF" stroke="#D0D5DD" stroke-width="1.2" filter="url(#cardShadow)"/>
  <rect x="180" y="216" width="5" height="64" rx="2.5" fill="#64748B"/>
  <text x="340" y="242" text-anchor="middle" font-size="13" font-weight="700" fill="#101828">Base YOLOv8 (COCO)</text>
  <text x="340" y="260" text-anchor="middle" font-size="11" fill="#667085">Person detection</text>

  <!-- Fine-tuned model -->
  <rect x="560" y="216" width="300" height="64" rx="10" fill="#FFFFFF" stroke="#B7DDC7" stroke-width="1.2" filter="url(#cardShadow)"/>
  <rect x="560" y="216" width="5" height="64" rx="2.5" fill="#2F8B5E"/>
  <text x="720" y="242" text-anchor="middle" font-size="13" font-weight="700" fill="#101828">Fine-Tuned YOLOv8 — RampGuard</text>
  <text x="720" y="260" text-anchor="middle" font-size="11" fill="#2F8B5E">Gloves · Helmet · Vest</text>

  <line x1="340" y1="280" x2="340" y2="310" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>
  <line x1="720" y1="280" x2="720" y2="310" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>

  <!-- Boxes output -->
  <rect x="180" y="310" width="300" height="52" rx="10" fill="#F8F9FB" stroke="#E4E7EC" stroke-width="1.2"/>
  <text x="340" y="341" text-anchor="middle" font-size="12" fill="#344054">Person bounding boxes</text>

  <rect x="560" y="310" width="300" height="52" rx="10" fill="#F3FAF6" stroke="#D6ECE0" stroke-width="1.2"/>
  <text x="720" y="335" text-anchor="middle" font-size="12" fill="#1F7A4E">PPE item boxes</text>
  <text x="720" y="350" text-anchor="middle" font-size="10.5" fill="#4C9873">+ confidence scores</text>

  <text x="60" y="404" font-size="10.5" font-weight="700" fill="#94A3B8" letter-spacing="1">03   CORRELATION</text>

  <!-- converge arrows -->
  <line x1="340" y1="362" x2="470" y2="420" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>
  <line x1="720" y1="362" x2="590" y2="420" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>
  <line x1="820" y1="186" x2="640" y2="420" stroke="#C99A3E" stroke-width="1.4" stroke-dasharray="5,3" marker-end="url(#arrowAmber)"/>

  <!-- Correlation engine -->
  <rect x="270" y="420" width="500" height="72" rx="12" fill="#FDF3F1" stroke="#EFC1B7" stroke-width="1.2" filter="url(#cardShadow)"/>
  <rect x="270" y="420" width="5" height="72" rx="2.5" fill="#C74A3C"/>
  <text x="530" y="450" text-anchor="middle" font-size="13.5" font-weight="700" fill="#8A281C">Dual-Model Correlation Engine</text>
  <text x="530" y="470" text-anchor="middle" font-size="11" fill="#A6493A">Bounding-box overlap analysis + METAR-conditional requirement lookup</text>

  <line x1="530" y1="492" x2="530" y2="522" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>

  <text x="60" y="514" font-size="10.5" font-weight="700" fill="#94A3B8" letter-spacing="1">04   CLASSIFICATION</text>

  <!-- Three-state classifier -->
  <rect x="230" y="522" width="580" height="90" rx="12" fill="#FFFFFF" stroke="#D0D5DD" stroke-width="1.2" filter="url(#cardShadow)"/>
  <text x="530" y="548" text-anchor="middle" font-size="13" font-weight="700" fill="#101828">Three-State Compliance Classifier</text>
  <text x="530" y="565" text-anchor="middle" font-size="10.5" fill="#98A2B3">Per PPE class, per detected person</text>

  <rect x="270" y="576" width="140" height="28" rx="14" fill="#E4F3EB"/>
  <circle cx="290" cy="590" r="4" fill="#2F8B5E"/>
  <text x="345" y="594" text-anchor="middle" font-size="11" font-weight="600" fill="#155C3C">COMPLIANT</text>

  <rect x="460" y="576" width="130" height="28" rx="14" fill="#FDECEA"/>
  <circle cx="480" cy="590" r="4" fill="#C74A3C"/>
  <text x="530" y="594" text-anchor="middle" font-size="11" font-weight="600" fill="#8A281C">VIOLATION</text>

  <rect x="640" y="576" width="150" height="28" rx="14" fill="#EEF1F5"/>
  <circle cx="660" cy="590" r="4" fill="#64748B"/>
  <text x="720" y="594" text-anchor="middle" font-size="11" font-weight="600" fill="#475569">INDETERMINATE</text>

  <line x1="530" y1="612" x2="530" y2="642" stroke="#94A3B8" stroke-width="1.4" marker-end="url(#arrow)"/>

  <text x="60" y="634" font-size="10.5" font-weight="700" fill="#94A3B8" letter-spacing="1">05   OUTPUT</text>

  <!-- Output -->
  <rect x="260" y="642" width="540" height="72" rx="12" fill="#EAF0FA" stroke="#B9CDEA" stroke-width="1.2" filter="url(#cardShadow)"/>
  <text x="530" y="672" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1E3A5F">Per-Person Compliance Report</text>
  <text x="530" y="692" text-anchor="middle" font-size="11" fill="#4A6E93">Per-item status · compliance rate · SMS-ready structured output</text>

  <!-- Footer -->
  <line x1="60" y1="734" x2="980" y2="734" stroke="#E4E7EC" stroke-width="1"/>
  <text x="60" y="756" font-size="10.5" fill="#98A2B3">Only <tspan font-weight="700" fill="#8A281C">vest</tspan> currently gates VIOLATION — helmet and gloves report COMPLIANT / INDETERMINATE only. See docs/PPE_TAXONOMY.md.</text>
  <text x="60" y="772" font-size="10.5" fill="#98A2B3">Dashed border = weather-conditional input, added 2026-08-13. See docs/RESEARCH_LOG.md.</text>
</svg>
ploading workflow.svg…]()
